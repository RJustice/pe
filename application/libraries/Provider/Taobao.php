	...
	public function get_user_info(OAuth2_Token_Access $token)
	{
		...
		$url = 'https://eco.taobao.com/router/rest?'.http_build_query(array(
            ...
            'fields' => 'user_id,uid,nick,location,avatar',
                    ...
                    get_instance()->load->library('rest',array('server'=>'https://eco.taobao.com/router/'),'restA');
                    get_instance()->restA->option(CURLOPT_SSL_VERIFYPEER,FALSE);
                    //var_dump($token->access_token);exit;
                    $user = get_instance()->restA->get('rest',array(
                            'access_token' => $token->access_token,
